...
namespace HenrikHannewijk\SessionTracker\Traits;

use Illuminate\Support\Facades\Session;
use Illuminate\Foundation\Application;
use HenrikHannewijk\SessionTracker\Models\Session as SessionTrack;
...
trait SessionTrackerUserTrait
{
    ...
    {
        return $this->hasMany('HenrikHannewijk\SessionTracker\Models\Session');
    }
    ...
    {
        return $this->hasMany('HenrikHannewijk\SessionTracker\Models\Device');
    }
